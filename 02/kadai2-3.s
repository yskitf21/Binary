...
./bin/fact:     file format elf64-x86-64
...
0000000000001040 <_start>:
    ...
    1061:	48 8d 3d 04 01 00 00 	lea    0x104(%rip),%rdi        # 116c <main>
...
0000000000001129 <fact>:
    1129:	f3 0f 1e fa          	endbr64 
    112d:	55                   	push   %rbp
    112e:	48 89 e5             	mov    %rsp,%rbp
    1131:	89 7d ec             	mov    %edi,-0x14(%rbp)
    1134:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
    1138:	7f 07                	jg     1141 <fact+0x18>
    113a:	b8 01 00 00 00       	mov    $0x1,%eax
    113f:	eb 29                	jmp    116a <fact+0x41>
    1141:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%rbp)
    1148:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
    114f:	eb 0e                	jmp    115f <fact+0x36>
    1151:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1154:	0f af 45 fc          	imul   -0x4(%rbp),%eax
    1158:	89 45 f8             	mov    %eax,-0x8(%rbp)
    115b:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    115f:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1162:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    1165:	7e ea                	jle    1151 <fact+0x28>
    1167:	8b 45 f8             	mov    -0x8(%rbp),%eax
    116a:	5d                   	pop    %rbp
    116b:	c3                   	retq   
...
000000000000116c <main>:
    ...
    1174:	bf 05 00 00 00       	mov    $0x5,%edi
    1179:	e8 ab ff ff ff       	callq  1129 <fact>
