...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d 33 01 00 00 	lea    0x133(%rip),%rdi        # 11bb <main>
...
0000000000001149 <fib>:
    1149:	f3 0f 1e fa          	endbr64 
    114d:	55                   	push   %rbp
    114e:	48 89 e5             	mov    %rsp,%rbp
    1151:	89 7d ec             	mov    %edi,-0x14(%rbp) # 引数 n をスタックに積む
    1154:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%rbp)
    115b:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    1162:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    # if (n == 1)
    1169:	83 7d ec 01          	cmpl   $0x1,-0x14(%rbp)
    116d:	75 08                	jne    1177 <fib+0x2e>
    116f:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1172:	89 45 f8             	mov    %eax,-0x8(%rbp)
    1175:	eb 3f                	jmp    11b6 <fib+0x6d>
    # elif (n == 2)
    1177:	83 7d ec 02          	cmpl   $0x2,-0x14(%rbp)
    117b:	75 0d                	jne    118a <fib+0x41>
    117d:   8b 55 f0             	mov    -0x10(%rbp),%edx
    1180:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1183:	01 d0                	add    %edx,%eax
    1185:	89 45 f8             	mov    %eax,-0x8(%rbp)
    1188:	eb 2c                	jmp    11b6 <fib+0x6d>
    # else
    # for
    118a:	c7 45 fc 03 00 00 00 	movl   $0x3,-0x4(%rbp) # i = 3
    1191:	eb 1b                	jmp    11ae <fib+0x65>
    1193:	8b 55 f0             	mov    -0x10(%rbp),%edx
    1196:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1199:	01 d0                	add    %edx,%eax
    119b:	89 45 f8             	mov    %eax,-0x8(%rbp)
    119e:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11a1:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11a4:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11a7:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11aa:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11ae:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11b1:	3b 45 ec             	cmp    -0x14(%rbp),%eax # n, i
    11b4:	7e dd                	jle    1193 <fib+0x4a>
    # endfor
    # endif
...
00000000000011bb <main>:
    ...
    11c7:	c7 45 fc 09 00 00 00 	movl   $0x9,-0x4(%rbp) # 9をスタックに積む
    11ce:	8b 45 fc             	mov    -0x4(%rbp),%eax # 9をeaxに入れる
    11d1:	89 c7                	mov    %eax,%edi # eaxをediに入れる
    11d3:	e8 71 ff ff ff       	callq  1149 <fib>
    ...
    11eb:	e8 60 fe ff ff       	callq  1050 <printf@plt>
